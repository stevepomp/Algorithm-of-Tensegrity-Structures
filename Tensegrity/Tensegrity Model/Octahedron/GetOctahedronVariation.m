function Tensegrity = GetOctahedronVariation(la)
% Octahedron tensegrity with additional cables.

n_strut = 6;n_cable = 30;
n_node = 2*n_strut;
...
Tensegrity.cable_group_physical(cable_group_id).modulus = [2.0e8,2.0e8,2.0e8];
cable_group_id = 2;
Tensegrity.cable_group_physical(cable_group_id).length = 0.536;
Tensegrity.cable_group_physical(cable_group_id).area = 1.0e-5;
Tensegrity.cable_group_physical(cable_group_id).rho = 7.80e3;
...
Tensegrity.cable_group_physical(cable_group_id).modulus = [2.0e8,2.0e8,2.0e8];
cable_group_id = 5;
Tensegrity.cable_group_physical(cable_group_id).length = la;
Tensegrity.cable_group_physical(cable_group_id).area = 1.0e-5;
Tensegrity.cable_group_physical(cable_group_id).rho = 7.80e3;
Tensegrity.cable_group_physical(cable_group_id).strain = [-1.0,0,1.0];
Tensegrity.cable_group_physical(cable_group_id).modulus = [2.0e8,2.0e8,2.0e8];
